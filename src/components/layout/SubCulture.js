...
const SubCulture = () => {
  return (
    <section className='sub-text-box' id='sub-text-box'>
      <h1>Our Culture</h1>
      <p>JUST SHOW UP.</p>
    </section>
    ...
    //   </h1>
    //   <p>
    //     Our Control Integrity Management System (CIMS) and Operational Integrity
    //     Management System (OIMS) are all centered on Safety and Sustainability.
    //     <br />
    //     <br />
